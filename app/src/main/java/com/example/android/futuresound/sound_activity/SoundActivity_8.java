...
import com.example.android.futuresound.track_adapter.TrackAdapter8;

import java.util.ArrayList;


public class SoundActivity_8 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TrackAdapter8 adapter = new TrackAdapter8(this, tracks);
