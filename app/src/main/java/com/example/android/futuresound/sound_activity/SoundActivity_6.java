...
import com.example.android.futuresound.track_adapter.TrackAdapter6;

import java.util.ArrayList;

public class SoundActivity_6 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TrackAdapter6 adapter = new TrackAdapter6(this, tracks);
